...
Run the [deploy workflow](https://github.com/DFE-Digital/check-childrens-barred-list/actions/workflows/build-and-deploy.yml) to recreate the missing postgres database as detailed below.
...
If users have entered data or new users have signed up, we may need to keep this data for reconciliation later on. Use the [Backup database to Azure storage workflow](https://github.com/DFE-Digital/check-childrens-barred-list/actions/workflows/backup-db.yml) to save a copy of the flawed database. Use a specific name to identify the backup file later on.
